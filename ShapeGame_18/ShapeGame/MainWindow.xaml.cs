...
namespace ShapeGame
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void WindowLoaded(object sender, EventArgs e)
        {
            ...
            this.myFallingThings = new FallingThings(this.targetFramerate, NumIntraFrames);
            ...
            FlyingText.NewFlyingText(
                this.screenRect.Width / 30, 
                new Point(this.screenRect.Width / 2, 
                this.screenRect.Height / 2), "Behold!");
        }
        ...
        #endregion Kinect discovery + setup5
